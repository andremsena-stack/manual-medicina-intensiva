# Fontes clinicas e tecnicas rastreaveis

Data de consulta/registro no projeto: 2026-05-18.

## Fonte interna local

### Documentos clinicos originais

- Link/local: `C:\Users\andre\OneDrive\Documentos\New project\MEDICINA\GUIA INTENSIVA\FONTES`
- Escopo: base local do projeto, com documentos clinicos originais.
- Modulos afetados: todos.
- Observacoes de seguranca: nao copiar, remover, renomear ou alterar sem autorizacao.
- Status: fonte interna.

## Fontes clinicas externas

### SCCM - PADIS Guidelines 2018

- Link: https://www.sccm.org/clinical-resources/guidelines/guidelines/guidelines-for-the-prevention-and-management-of-pa
- Link PubMed: https://pubmed.ncbi.nlm.nih.gov/30113379/
- Referencia: Devlin JW, Skrobik Y, Gelinas C, et al. Clinical Practice Guidelines for the Prevention and Management of Pain, Agitation/Sedation, Delirium, Immobility, and Sleep Disruption in Adult Patients in the ICU. Crit Care Med. 2018;46(9):e825-e873.
- Escopo: dor em UTI, agitacao, sedacao, delirium, imobilidade, sono, escolha/profundidade de sedacao e monitorizacao.
- Modulos afetados: sedoanalgesia; sedacao pos-IOT; analgesia em ventilacao mecanica; RASS; delirium; sedacao leve versus profunda.
- Observacoes de seguranca: nao atualizar recomendacoes clinicas automaticamente.
- Status: fonte externa.

### SCCM - Focused Update PADIS 2025

- Link: https://sccm.org/clinical-resources/guidelines/guidelines/focused-update-padis-guideline
- Link PubMed: https://pubmed.ncbi.nlm.nih.gov/39982143/
- Referencia: Lewis K, Balas MC, Stollings JL, et al. A Focused Update to the Clinical Practice Guidelines for the Prevention and Management of Pain, Anxiety, Agitation/Sedation, Delirium, Immobility, and Sleep Disruption in Adult Patients in the ICU. Crit Care Med. 2025;53(3):e711-e727.
- Escopo: ansiedade, agitacao/sedacao, delirium, mobilidade, sono e desfechos de UTI.
- Modulos afetados: sedoanalgesia; escolha de sedativos; delirium; sono; mobilidade; ansiedade em UTI.
- Observacoes de seguranca: divergencias com conteudo hospedado devem ser sinalizadas para revisao medica.
- Status: fonte externa.

### Difficult Airway Society - Tracheal Intubation in Critically Ill Adults

- Link: https://das.uk.com/guidelines/guidelines-for-the-management-of-tracheal-intubation-in-critically-ill-adults/
- Link artigo: https://www.bjanaesthesia.org/article/S0007-0912(17)54060-X/fulltext
- Link PubMed: https://pubmed.ncbi.nlm.nih.gov/29406182/
- Referencia: Higgs A, McGrath BA, Goddard C, et al. Guidelines for the management of tracheal intubation in critically ill adults. Br J Anaesth. 2018;120(2):323-352.
- Escopo: intubacao traqueal no paciente critico, pre-oxigenacao, plano de via aerea, UTI/emergencia e seguranca peri-intubacao.
- Modulos afetados: IOT; sequencia rapida; pre-oxigenacao; via aerea dificil; checklist; cuidados peri-intubacao.
- Observacoes de seguranca: mudancas em algoritmo de via aerea requerem revisao medica.
- Status: fonte externa.

### Difficult Airway Society 2025/2026 - Failed Tracheal Intubation in Adults

- Link: https://www.bjanaesthesia.org.uk/article/S0007-0912(25)00693-2/fulltext
- Escopo: falha de intubacao, limite de tentativas, declaracao formal de falha, plano B, resgate de oxigenacao e estrategia cannot intubate/cannot oxygenate.
- Modulos afetados: via aerea falha; algoritmo de resgate; checklist de IOT; planos A/B/C/D; cricotireoidostomia de emergencia.
- Observacoes de seguranca: nao implementar mudancas sem revisao medica, pois envolve decisoes criticas de via aerea.
- Status: fonte externa.
...
- Algoritmos: https://cpr.heart.org/en/resuscitation-science/cpr-and-ecc-guidelines/algorithms
- Link artigo: https://www.ahajournals.org/doi/10.1161/CIR.0000000000001372
- Link artigo: https://www.ahajournals.org/doi/10.1161/CIR.0000000000001376
- Escopo: suporte basico, suporte avancado, parada cardiorrespiratoria, algoritmos de PCR, pos-PCR e emergencia cardiovascular.
- Modulos afetados: PCR; SAVC/ACLS; pos-PCR; drogas em parada; algoritmos de ritmo chocavel e nao chocavel; cuidados pos-ROSC.
- Observacoes de seguranca: nao alterar algoritmos de PCR sem revisao medica.
- Status: fonte externa.

### American Heart Association - 2023 Focused Update on Adult ACLS

- Link: https://www.ahajournals.org/doi/10.1161/CIR.0000000000001194
- Link profissional: https://professional.heart.org/en/guidelines-statements/2023-american-heart-association-focused-update-on-adult-advanced-cardiovascularcir0000000000001194
- Escopo: ECPR, controle de temperatura, angiografia pos-PCR, medicacoes durante PCR e cuidados pos-PCR.
- Modulos afetados: PCR; pos-PCR; drogas em ACLS; cuidados apos ROSC.
- Observacoes de seguranca: alteracoes em algoritmos ou medicacoes requerem revisao medica.
- Status: fonte externa.

### ESICM - Circulatory Shock and Hemodynamic Monitoring 2025

- Link PubMed: https://pubmed.ncbi.nlm.nih.gov/41236566/
- Escopo: diagnostico de choque, monitorizacao hemodinamica, perfusao periferica, TEC, lactato, ScvO2, diferenca venoarterial de CO2, responsividade a fluidos e ecocardiografia.
- Modulos afetados: choque; drogas vasoativas; hemodinamica; lactato; microcirculacao; responsividade a fluidos; ecocardiografia; perfusao periferica.
...
- Escopo: semantica, formularios, acessibilidade e organizacao de conteudo.
- Modulos afetados: estrutura da aplicacao.
- Observacoes de seguranca: sem impacto clinico.
- Status: fonte externa.

### MDN Web Docs - CSS

- Link: https://developer.mozilla.org/en-US/docs/Web/CSS
- Escopo: responsividade, layout, impressao, variaveis CSS e media queries.
- Modulos afetados: interface e impressao.
- Observacoes de seguranca: sem impacto clinico.
- Status: fonte externa.
...
- Escopo: calculadoras, validacao, eventos e manipulacao do DOM.
- Modulos afetados: interface de calculadoras e validacao.
- Observacoes de seguranca: nao alterar formulas clinicas ao refatorar.
- Status: fonte externa.

### Chart.js

- Link: https://www.chartjs.org/docs/latest/getting-started/
- Escopo: graficos e visualizacoes educacionais.
- Modulos afetados: nenhum no v1.
- Observacoes de seguranca: usar apenas se o projeto incluir graficos ou se solicitado.
- Status: fonte externa.

### html2pdf.js

- Link: https://github.com/eKoopmans/html2pdf.js
- Escopo: exportacao client-side de HTML para PDF.
- Modulos afetados: exportacao futura.
- Observacoes de seguranca: nao substituir por outra biblioteca sem autorizacao.
- Status: fonte externa.

### Tailwind CSS - Play CDN

- Link: https://tailwindcss.com/docs/installation/play-cdn
- Escopo: prototipagem rapida.
- Modulos afetados: nenhum no v1.
- Observacoes de seguranca: aceitavel apenas para prototipo; producao deve usar CSS local/build adequado.
- Status: fonte externa.
